...
(ESET-KeyGen - генератор пробных ключей и учетных записей для продуктов ESET)
...
### Важно: Этот инструмент предназначен только для образовательных целей.
Использование этого инструмента может нарушать условия обслуживания ESET и иметь юридические последствия.
Авторы и составители не несут ответственности за любое неправильное использование или ущерб, причиненный этим проектом.
Используйте его на свой страх и риск и только на тех системах, которые принадлежат вам или имеют явное разрешение на тестирование.
